  ...
  return (
    <section id="about" className="py-20 sm:py-24 px-5 sm:px-8 lg:px-10 bg-white">
      <ScrollReveal className="max-w-5xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto rounded-2xl border border-line border-l-4 border-l-accent bg-bg p-7 sm:p-8 text-center transition-all duration-300 hover:shadow-lg hover:shadow-primary/10">
